...
if __name__ == '__main__':
    ...
    if os.name == 'posix':  # Yeah, we're in UNIX boiz.
        ...
        batch_file.write('export CAS_DB_NAME={0}\n'.format(db_name))
        batch_file.write('export CAS_DB_USERNAME={0}\n'.format(db_username))
        batch_file.write('export CAS_DB_PASSWORD={0}\n'.format(db_password))
        batch_file.write('export CAS_DB_HOST={0}\n'.format(db_host))
        batch_file.write('export CAS_DB_PORT={0}\n'.format(db_port))
        batch_file.write('export CAS_SECRET_KEY={0}\n'.format(secret_key))
        batch_file.close()
